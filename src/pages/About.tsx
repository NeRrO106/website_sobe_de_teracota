  ...
  return (
    <div className="flex-grow bg-amber-700 min-h-screen pb-12">
      <div className="flex flex-col items-center justify-center text-center px-6 py-20 sm:py-32 relative z-10">
        ...
        <p className="text-lg sm:text-xl max-w-2xl text-stone-800">
          La Atelier Sobe, tradiția întâlnește calitatea. Realizăm sobe de
          teracotă manual, cu pasiune și atenție la detalii.
        </p>
      </div>
      <div className="bg-yellow-500 text-stone-800 rounded-3xl mt-4 p-12 max-w-5xl mx-auto relative z-10">
        <h2 className="text-3xl font-bold mb-6 text-cyan-50">
          Povestea noastră
        </h2>
        <p className="mb-4">
        ...
        <h3 className="text-2xl font-semibold mt-8 mb-4 text-cyan-50">
          Valorile noastre
        </h3>
